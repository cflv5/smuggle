...
Response.prototype.render = function render(view, data, options) {
    const body = this.app.renderFile(view, data, options);
...
Response.prototype.build = function build() {
    let response = {};

    response.statusCode = this.statusCode;
    response.body = String(this.body);

    response.headers = {};
    response.multiValueHeaders = {};
    Object.assign(response.headers, this.headers);
    Object.assign(response.multiValueHeaders, this.multiValueHeaders);

    response.isBase64Encoded = this.base64Encoded;
